...
/*bool check_collision(float *linearray1, float *linearray2, float x1, float y1, float x2, float y2, char numoflines1, char numoflines2) { //check for collision between 2 shapes
	char i = 1;
	float *line1 = (float*)malloc(5 * sizeof(float));
	float *line2 = (float*)malloc(5 * sizeof(float));
	while (i <= numoflines1) {
